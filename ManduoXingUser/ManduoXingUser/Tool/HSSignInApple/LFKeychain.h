...
/**
 Error code specific to LFKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, LFKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	LFKeychainErrorBadArguments = -1001,
};

/** LFKeychain error domain */
extern NSString *const kLFKeychainErrorDomain;

/** Account name. */
extern NSString *const kLFKeychainAccountKey;
 ...
 */
extern NSString *const kLFKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kLFKeychainClassKey;

/** Item description. */
extern NSString *const kLFKeychainDescriptionKey;

/** Item label. */
extern NSString *const kLFKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kLFKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kLFKeychainWhereKey;
...
/**
 ...
 LFKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in LFKeychain.h for a list of keys that can be used when accessing the
