...
NS_ASSUME_NONNULL_BEGIN
	...
	#define LFKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define LFKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef LFKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, LFKeychainQuerySynchronizationMode) {
	LFKeychainQuerySynchronizationModeAny,
	LFKeychainQuerySynchronizationModeNo,
	LFKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface LFKeychainQuery : NSObject
...
@property (nonatomic) LFKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 LFKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
