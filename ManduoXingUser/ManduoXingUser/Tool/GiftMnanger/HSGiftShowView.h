...
typedef void(^completeShowViewKeyBlock)(HSGiftModel *giftModel);
...
@interface HSGiftShowView : UIView
/**
 展示礼物动效
 ...
 */
- (void)showGiftShowViewWithModel:(HSGiftModel *)giftModel
...
/** model */
@property(nonatomic,strong) HSGiftModel *finishModel;
@end
